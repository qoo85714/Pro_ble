...
//            BluetoothLog.w("MainActivity.onDeviceFounded " + device.device.getAddress());
            if (!mDevices.contains(device)) {
                Log.i("MainActivity.onFounded ","mDevices");
                mDevices.add(device);
...
//                Log.i("brad:","firstByte"+firstByte);
//                Log.i("bard:","secondByte"+secondByte);
//                Log.i("brad:","productId"+productId);
//                Log.i("brad:","bit1"+bit1);
//                Log.i("brad:","bit2"+bit2);
